...
JF.initialize({ apiKey: "bd97e6ecfde5bccc57d2b272626c7ab2" }); //PUT YOUR OWN KEY HERE

// testing if console works
// console.log("hi")
 
// get form submissions from JotForm Format: (formID, callback)
JF.getFormSubmissions("223123884557057", function (response) {
...
// YOUR MAPBOX TOKEN HERE
  ...
  const map = new mapboxgl.Map({
    ...
    style: "mapbox://styles/primra/cla4c12d6000714s16cjqijiq", // Your style URL
    ...
    map.addLayer(
      new MapboxLayer({
        ...
        onClick: (info) => {
          ...
          getImageGallery(info.object.imageUpload, info.object.description);
        },  
      }),
      firstLabelLayerId
    );
